...
exports.run = async (client, message, args) => {
    ...
    try {
        ...
        if (lastDaily !== null && cooldown - (Date.now() - lastDaily) > 0) {
            ...
            .setDescription(`Sorry, you cannot collect your dailies too early. Please wait until ${finalTime}!`)
            ...
            const well = new Discord.MessageEmbed()
            .setDescription(`Great **${message.author.tag}!** You've been received 500 dollars!`)
            return message.channel.send(well);
        }
...
exports.help = {
    name: "daily",
    description: "Collect your daily moneys.",
